...
export const posts = [
    ...
    {
      slug: 'history-of-ufc-rule-changes',
    ...
    {
      slug: 'evolution-of-ufc-pay-per-view',
      title: 'Evolution of UFC Pay-Per-View Events',
      excerpt: 'How the UFC transformed pay-per-view into a global revenue engine.',
      body: '<p>UFC embraced pay-per-view (PPV) with UFC 13 in 1997, charging $19.95 per event. Early buy rates hovered around 50,000, but marquee matchups like Ken Shamrock vs. Tito Ortiz pushed numbers higher.</p><p>In 2006, breaking into mainstream cable deals and ESPN partnerships elevated PPV buys above 500,000 for events like Ortiz vs. Maynard. The model shifted to digital on UFC 251 (2020), with streaming platforms increasing global access.</p><p>By 2025, UFC PPVs average 1.2 million buys, with dynamic pricing ($79–$99) and subscription bundles driving revenue. The UFC Fight Pass streaming service adds a monthly subscription model alongside traditional PPV.</p>'
    },
    {
      slug: 'rise-of-womens-divisions',
      title: 'Rise of Women’s Divisions in UFC',
      excerpt: 'From inaugural fights to headlining pay-per-views, a look at women’s MMA growth.',
      body: '<p>Women’s MMA debuted in the UFC under Ronda Rousey at UFC 157 (2013). Rousey’s armbar finishes captivated audiences and shattered gender barriers in combat sports.</p><p>In 2016, UFC introduced multiple weight classes: Strawweight, Bantamweight, and Featherweight. Fighters like Joanna Jędrzejczyk, Amanda Nunes, and Valentina Shevchenko became crossover stars, headlining PPVs.</p><p>By 2025, women’s bouts headline major cards, and UFC records show women’s title fights drawing higher buy rates than many men’s matches. The expansion continues with international talent pipelines in Asia and Europe.</p>'
    },
    {
      slug: 'iconic-ufc-moments',
      title: 'Iconic UFC Moments That Defined the Sport',
      excerpt: 'Memorable fights and moments that became part of UFC lore.',
      body: '<p>Conor McGregor’s 13-second KO of José Aldo at UFC 194 (2015) stands as the fastest featherweight finish in title fight history, propelling UFC into global pop culture.</p><p>Georges St-Pierre’s comeback victory at UFC 217 (2017) showcased technical mastery and strategic adaptation, solidifying his GOAT status.</p><p>Amanda Nunes’ back-to-back title defenses at UFC 232 (2018) and UFC 259 (2021) demonstrated her dominance as the first woman to hold two belts simultaneously.</p><p>Jon Jones’ dramatic knockout of Ciryl Gane at UFC 285 (2023) introduced innovative striking and cemented his legacy across two weight classes.</p>'
    }
  ]
